...
export default function Index({ posts, globalData }) {
  return (
    <Layout>
      ...
      <main className="w-full">
        <h1 style={{marginTop:20}} className="text-3xl lg:text-5xl text-center mb-12">
          {globalData.blogTitle}
        </h1>
          <p style={{color:'black'}} className="uppercase mb-3 font-bold opacity-60">
            {`What is IndiGG?`}
          </p>
          <p className="uppercase mb-3 font-bold opacity-60">
          ...
          <p style={{color:'black'}} className="uppercase mb-3 font-bold opacity-60">{`How do I get started using IndiGG Wallet?`}</p>
          ...
          <p style={{color:'black'}} className="uppercase mb-3 font-bold opacity-60">{`What is KYC?`}</p>
          ...
          <p style={{color:'black'}} className="uppercase mb-3 font-bold opacity-60">{`What is a crypto wallet?`}</p>
          ...
          <p style={{color:'black'}} className="uppercase mb-3 font-bold opacity-60">{`Is it safe to use IndiGG Wallet?`}</p>
          ...
          <p style={{color:'black'}} className="uppercase mb-3 font-bold opacity-60">{`How do I add funds to my wallet?`}</p>
          ...
          <p style={{color:'black'}} className="uppercase mb-3 font-bold opacity-60">{`How do I send payments using IndiGG Wallet?`}</p>
          ...
          <p style={{color:'black'}} className="uppercase mb-3 font-bold opacity-60">{`Are there any fees associated with using IndiGG Wallet?`}</p>
          ...
          <p style={{color:'black'}} className="uppercase mb-3 font-bold opacity-60">{`Do I need a crypto wallet to join IndiGG?`}</p>
          ...
          <p style={{color:'black'}}className="uppercase mb-3 font-bold opacity-60">{`Do I need cryptocurrencies to use IndiGG Wallet?`}</p>
          ...
          <p style={{color:'black'}}className="uppercase mb-3 font-bold opacity-60">{`What currencies does IndiGG Wallet support?`}</p>
          <p className="uppercase mb-3 font-bold opacity-60">{`We only support $USDT at this time.`}</p>
          <p style={{color:'black'}}className="uppercase mb-3 font-bold opacity-60">{`Does IndiGG Wallet Support NFTs?`}</p>
          ...
          <p style={{color:'black'}}className="uppercase mb-3 font-bold opacity-60">{`Can I exchange my tokens for real money?`}</p>
          ...
          <p style={{color:'black'}}className="uppercase mb-3 font-bold opacity-60">{`Why can’t I Send / Receive / Redeem my tokens?`}</p>
          ...
          <p  style={{color:'black'}}className="uppercase mb-3 font-bold opacity-60">{`Is being a member of IndiGG a legitimate way to earn rewards?`}</p>
          ...
          <p style={{color:'black'}}className="uppercase mb-3 font-bold opacity-60">{`How can I find and speak to other members of IndiGG?`}</p>
          ...
          <p style={{color:'black'}}className="uppercase mb-3 font-bold opacity-60">{`What kind of games can I play to earn rewards with IndiGG?`}</p>
          ...
          <p style={{color:'black'}}className="uppercase mb-3 font-bold opacity-60">{`How do I earn rewards with IndiGG?`}</p>
          ...
          <p style={{color:'black'}}className="uppercase mb-3 font-bold opacity-60">{`Can I withdraw the rewards I earn with IndiGG?`}</p>
